...
Therefore, on \(E_{a}\),
\begin{equation*}
  \tilde{\sigma}_{m} (a) = \omega
  \left\{ \frac{1}{m_{a}} \sum_{i : A_{i} = a} (\varepsilon_{i} -
  \bar{\varepsilon} (a))^{2} \right\}^{1/2}, \quad \text{where} \quad
  \bar{\varepsilon} (a) = \frac{1}{m_{a}} \sum_{i : A_{i} = a} \varepsilon_{i}.
\end{equation*}
Since
\begin{equation*}
...
we obtain
\begin{equation*}
  \E \left[ \tilde{\sigma}_{m}^{-1} (a) \middle| E_{a} \right] = \omega^{-1}
  \sqrt{m_{a}} \E \left[ \chi_{m_{a} - 1}^{-1} \right].
\end{equation*}
...
\begin{equation*}
  ...
  2^{1 - m_{a}} \omega^{-1} \sqrt{m_{a}} \E \left[ \chi_{m_{a} - 1}^{-1}
  \right] \to \infty,
\end{equation*}
...
\begin{equation*}
  ...
  \left\{ \frac{1}{m_{a}} \sum_{i : A_{i} = a} (W_{i} - \bar{W}_{a})^2
  \right\}^{1/2}.
\end{equation*}
Therefore,
\begin{equation*}
  \E \left[ \tilde{\sigma}_{m} (a) \right] \to
  \E \left[ \left\{ \frac{1}{m_{a}} \sum_{i : A_{i} = a} (W_{i} -
